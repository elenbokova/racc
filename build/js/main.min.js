...
/* harmony import */ var _modules_sticky_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sticky-header */ "./js/modules/sticky-header.js");
/* harmony import */ var _modules_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/locomotive-scroll */ "./js/modules/locomotive-scroll.js");
/* harmony import */ var _modules_init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-locomotive-scroll */ "./js/modules/init-locomotive-scroll.js");
...
/* harmony import */ var _modules_single_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/single-slider */ "./js/modules/single-slider.js");
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/tab */ "./js/modules/tab.js");
/* harmony import */ var _utils_phone_check__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/phone-check */ "./js/utils/phone-check.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_4__["initLocomotiveScroll"])();
  ...
  window.addEventListener('load', function () {
    ...
    burger.init();
    var stickyHeader = new _modules_sticky_header__WEBPACK_IMPORTED_MODULE_2__["StickyHeader"]();
    stickyHeader.init();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_5__["initModals"])();
    Object(_modules_single_slider__WEBPACK_IMPORTED_MODULE_6__["initSingleSlider"])();
    Object(_modules_tab__WEBPACK_IMPORTED_MODULE_7__["initTabs"])();
    Object(_utils_phone_check__WEBPACK_IMPORTED_MODULE_8__["initPhoneCheck"])();
  });
});
...
/***/ "./js/modules/init-locomotive-scroll.js":
/*!**********************************************!*\
  !*** ./js/modules/init-locomotive-scroll.js ***!
  \**********************************************/
...
/***/ "./js/modules/locomotive-scroll.js":
/*!*****************************************!*\
  !*** ./js/modules/locomotive-scroll.js ***!
  \*****************************************/
...
var quotes = document.querySelector('[data-id="intro"]');
var swiper;
...
var tabsControls = document.querySelectorAll('.tabs__control-button');
var tabsContent = document.querySelectorAll('.tabs__item');
var stateHandler = function stateHandler(element, id) {
  ...
  if (tabs) {
    tabs.addEventListener('click', function (evt) {
      if (evt.target.classList.contains('tabs__control-button')) {
        var tabsPath = evt.target.dataset.tabsTarget;
